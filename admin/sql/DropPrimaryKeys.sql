...
ALTER TABLE artist_deletion DROP CONSTRAINT IF EXISTS artist_deletion_pkey;
...
ALTER TABLE label_deletion DROP CONSTRAINT IF EXISTS label_deletion_pkey;
...
ALTER TABLE series_deletion DROP CONSTRAINT IF EXISTS series_deletion_pkey;
